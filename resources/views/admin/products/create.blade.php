    ...
    <div class="max-w-3xl mx-auto py-10 rounded  bg-white">
        <div class="bg-white shadow-lg rounded-xl p-8">
            ...
            <form action="{{ route('admin.products.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    <label for="user_id" class="block text-sm font-medium text-gray-700 mb-1">Hotel (User)</label>
                    <select name="user_id" id="user_id" class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded pl-3 pr-8 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-400 shadow-sm focus:shadow-md appearance-none cursor-pointer">
                ...
                <div>
                    ...
                    <select name="category_id" id="category_id"         class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded pl-3 pr-8 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-400 shadow-sm focus:shadow-md appearance-none cursor-pointer">                        >
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="price" id="price" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
                </div>
