    ...
    <div class="max-w-xl mx-auto p-10 rounded  bg-white ">
        ...
        <form method="POST"
            ...
            <div class="mb-4">
                ...
                <textarea name="description" class="p-3 w-full border-gray-300 rounded-md shadow-sm" rows="3">{{ old('description', $category->description ?? '') }}</textarea>
            </div>

            <div class="flex justify-end">
                <a href="{{ route('admin.categories.index') }}"
                    class="mr-2 px-4 py-2 bg-gray-200 rounded hover:bg-gray-300">Cancel</a>
